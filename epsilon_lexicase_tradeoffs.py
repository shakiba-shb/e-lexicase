                ...
                for mu in MU:
                    ...
                    for it in range(n_iters):  
                        ...
                        while (counter < max_loops):
                            ...
                            #print("type of phenotypes:", phenotypes)

                            prob = lexicase.LexicaseFitness(phenotypes, 2.0) #calculate probablity of being selected by lexicase selection
                            P_survival = list((np.ones(len(prob)) - (np.ones(len(prob)) - prob)**ss)**g) #probability of survival based on equation(3)
                            #print('prob:', prob)
                            #print('genotypes:', new_pop)
